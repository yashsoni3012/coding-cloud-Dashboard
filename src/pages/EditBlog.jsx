        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-sm text-gray-500 font-medium">Loading blog details…</p>
                </div>
            </div>
        );
    }
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 space-y-5">
                            ...
                            {/* Short Description */}
                            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                                <label htmlFor="short_description" className="block text-sm font-semibold text-gray-800 mb-1">
                                    Short Description
                                </label>
                            ...
                            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-5">
                                ...
                                <div>
                                    <div className="flex items-center gap-2 mb-1">
                                        ...
                                        <label htmlFor="meta_title" className="text-sm font-semibold text-gray-800">Meta Title</label>
                                    </div>
                                ...
                                {/* Meta Description */}
                                <div>
                                    <label htmlFor="meta_descrtiption" className="block text-sm font-semibold text-gray-800 mb-1">Meta Description</label>
                                ...
                                <div>
                                    <div className="flex items-center gap-2 mb-1">
                                        ...
                                        <label htmlFor="meta_keyword" className="text-sm font-semibold text-gray-800">Meta Keywords</label>
                                    </div>
                                ...
                                <div>
                                    <div className="flex items-center gap-2 mb-1">
                                        ...
                                        <label htmlFor="hashtag" className="text-sm font-semibold text-gray-800">Hashtags</label>
                                    </div>
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-5">
                                ...
                                {/* Publish Date */}
                                <div>
                                    <label htmlFor="publish_date" className="block text-sm font-semibold text-gray-800 mb-1">
