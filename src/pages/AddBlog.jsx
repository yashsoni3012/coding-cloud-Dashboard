...
export default function AddBlog() {
  ...
  const handleInputChange = (e) => {
    ...
    if (name === "meta_title" || name === "meta_descrtiption" || name === "meta_keyword") {
  ...
  const validateForm = () => {
    ...
    const metaDescWords = getWordCount(formData.meta_descrtiption);
    if (metaDescWords > 500) {
      errors.meta_descrtiption = `Maximum 500 words allowed. Currently ${metaDescWords} words.`;
    }
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3 bg-gray-50 border rounded-xl text-gray-900 text-base placeholder-gray-400 outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent focus:bg-white transition-all resize-none ${
                      fieldErrors.meta_descrtiption ? "border-red-500" : "border-gray-200"
                    }`}
                  />
                  <div className="flex justify-between items-center mt-1">
                    <p className="text-xs text-gray-400">
                      Word count: {getWordCount(formData.meta_descrtiption)} / 500
                    </p>
                    {fieldErrors.meta_descrtiption && (
                      <p className="text-xs text-red-500">{fieldErrors.meta_descrtiption}</p>
                    )}
                  </div>
                </div>
                <div className="h-px bg-gray-100" />
