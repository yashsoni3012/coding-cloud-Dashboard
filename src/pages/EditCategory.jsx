    ...
    useEffect(() => {
        const fetchCategory = async () => {
            try {
                ...
                if (categoryData) {
                    setFormData({ name: categoryData.name || "", text: categoryData.text || "", image: null });
                    if (categoryData.image) {
                        const fullImageUrl = `https://codingcloud.pythonanywhere.com${categoryData.image}`;
                        setImagePreview(fullImageUrl);
                        setOriginalImage(fullImageUrl);
            ...
            <header className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-base sm:text-lg font-bold text-gray-900 leading-tight">Edit Category</h1>
                            <p className="text-xs text-gray-400 hidden sm:block">Update category details</p>
                        </div>
                    </div>
